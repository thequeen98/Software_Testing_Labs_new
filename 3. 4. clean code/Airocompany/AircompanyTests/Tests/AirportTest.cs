...
namespace AircompanyTests.Tests
{
    ...
    {
        static private List<Plane> planes = new List<Plane>(){
        ...
        public void GetPassengerPlaneWithMaxPassengersCapacity()
        {
            ...
            Assert.AreEqual(expectedPlaneWithMaxPassengersCapacity.PassengersCapacity, airport.GetPlanes<PassengerPlane>().Max(plane => plane.PassengersCapacity));
        }
